...
def classify(review):
    ...
    with tf.Session() as sess:
        ...
        saver = tf.train.import_meta_graph(os.path.join(os.getcwd(), "models", "custom_RNN","sentiment-19.ckpt.meta"))
        saver.restore(sess, tf.train.latest_checkpoint(os.path.join(os.getcwd(), "models", "custom_RNN")))
